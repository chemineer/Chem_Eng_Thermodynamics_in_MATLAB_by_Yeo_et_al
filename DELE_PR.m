%DELE_PR.m : 상태1->상태2에서 에너지(U,H,S) 변화

function [Z1,Z2,DU,DH,DS]=DELE_PR(T1,T2,P1,P2,Pc,Tc,w,A,B,C,D)
%input
...
% A,B,C,D : Cp data
%output
% DU, DH, DS : values of departure functions
% Z1, Z2 : number of real roots at state1 and 2
